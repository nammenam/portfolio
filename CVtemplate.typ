...
#let section(title) = {
    block(
      ...
      inset: 6pt,
      radius: 2pt,
      text(12pt, fill: headings-colour, weight: "black", font: "Geist")[
        #upper[#title]
      ],
    )
}
...
#let subsection(content) = {
  text(10pt, fill: subheadings-colour, weight: "bold")[#content]
}
...
#let education(institution: "", major: "", date: "", location: "", description: "") = {
  ...
  h(1fr)
  text(9pt, fill: headings-colour, weight:"regular")[#date \ ]
  text(11pt, style: "italic", fill: subheadings-colour, weight: "semibold")[#major \ ]
  if description != [] or description != "" {
    text(9pt, fill: primary-colour, weight: "regular")[#description]
  }
}

// Projects
#let project(title, date, info) = {
  text(11pt, fill: subheadings-colour)[#title ]
  if date != [] or date != "" {
    h(1fr)
    text(9pt, fill: headings-colour,  font: "Geist")[#date \ ]
  } else {
    [\ ]
  }
  if info != [] or info != "" {
    text(10pt, fill: primary-colour, weight: "light")[#info ]
  }
}

// Description of a job, degree, etc
#let descript(content) = {
  text(9pt, fill: primary-colour, weight: "regular")[#content ]
}

// Job title
#let job(position: "", institution: "", location: "", date: "", description: "") = {
  text(11pt, fill: subheadings-colour, weight: "bold")[#position]
  h(1fr)
  text(9pt, fill: headings-colour, weight: "bold")[#location \ ]
  text(11pt, style: "italic", fill: subheadings-colour, weight: "semibold")[#institution]
  h(1fr)
  text(9pt, fill: headings-colour)[#date]
  if description != [] or description != "" {
    text(9pt, fill: primary-colour)[#description]
  }
}
...
#let oneline-two(entry1: "", entry2: "") = {
  ...
  h(1fr)
  text(9pt, fill: primary-colour, weight: "regular")[#entry2 \ ]
}

#let twoline-item(entry1: none, entry2: none, entry3: none, entry4: none, description: none) = {
  text(11pt, fill: subheadings-colour, weight: "bold")[#entry1 \ ]
  if entry2 != none {
    text(9pt, fill: headings-colour, weight: "regular", font:"Geist")[#entry2 #v(0em)]
  }
  if entry3 != [] or entry3 != "" != none {
    text(10pt, style: "italic", fill: subheadings-colour, weight: "medium")[#entry3]
  }
  if entry4 != none {
    h(1fr)
...
#let award(award: "", institution: "", date: "") = {
  [#text(11pt, fill: primary-colour, weight: "medium")[#award,] #text(
      ...
      fill: primary-colour,
      weight: "regular",
    )[#emph(institution)] #h(1fr) #text(9pt, fill: primary-colour, weight: "regular", font:"Geist")[#emph(date)\ ]]
}
